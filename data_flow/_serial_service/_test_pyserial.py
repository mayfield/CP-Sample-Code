...
def test_object():
    ...
    message = b'Hello\n'
    count = obj.write(message)
    data = obj.read(10)

    logger.info('serial wrt = {0} count={1}'.format(message, count))
    logger.info('serial rcv data = {0}'.format(data))
    logger.info('serial rcv type = {0}'.format(type(data)))
